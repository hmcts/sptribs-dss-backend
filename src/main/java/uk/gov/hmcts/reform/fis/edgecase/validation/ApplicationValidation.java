package uk.gov.hmcts.reform.fis.edgecase.validation;

import uk.gov.hmcts.reform.fis.edgecase.model.Application;
import uk.gov.hmcts.reform.fis.edgecase.model.CaseData;

import java.util.ArrayList;
import java.util.List;

import static uk.gov.hmcts.reform.fis.edgecase.validation.ValidationUtil.flattenLists;
// import static uk.gov.hmcts.reform.adoption.adoptioncase.validation.ValidationUtil.validateApplicant2BasicCase;
import static uk.gov.hmcts.reform.fis.edgecase.validation.ValidationUtil.validateBasicCase;
