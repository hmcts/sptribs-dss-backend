package uk.gov.hmcts.reform.fis.document;
...
import static uk.gov.hmcts.reform.fis.common.config.ControllerConstants.SERVICE_AUTHORIZATION;
import static uk.gov.hmcts.reform.fis.document.DocumentConstants.DOCUMENT_DELETE_URI;
import static uk.gov.hmcts.reform.fis.document.DocumentConstants.DOCUMENT_DOWNLOAD_URI;
import static uk.gov.hmcts.reform.fis.document.DocumentConstants.PERMANENT;
import static uk.gov.hmcts.reform.fis.document.DocumentConstants.USER_ID;
import static uk.gov.hmcts.reform.fis.document.DocumentConstants.USER_ROLES;
