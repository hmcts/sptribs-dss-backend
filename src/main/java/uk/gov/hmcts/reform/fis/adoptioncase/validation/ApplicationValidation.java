package uk.gov.hmcts.reform.fis.adoptioncase.validation;

import uk.gov.hmcts.reform.fis.adoptioncase.model.Application;
import uk.gov.hmcts.reform.fis.adoptioncase.model.CaseData;

import java.util.ArrayList;
import java.util.List;

import static uk.gov.hmcts.reform.fis.adoptioncase.validation.ValidationUtil.flattenLists;
// import static uk.gov.hmcts.reform.adoption.adoptioncase.validation.ValidationUtil.validateApplicant2BasicCase;
import static uk.gov.hmcts.reform.fis.adoptioncase.validation.ValidationUtil.validateBasicCase;
