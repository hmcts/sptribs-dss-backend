...
import static uk.gov.hmcts.reform.fis.document.DocumentType.APPLICATION;
...
public class DraftApplicationRemovalService {
    ...
    public List<ListValue<AdoptionDocument>> removeDraftApplicationDocument(
        ...
        log.info("Successfully removed application document from case data generated document list for case id {} ",
                 caseId);
