...
import uk.gov.hmcts.reform.fis.document.content.DocmosisTemplateProvider;
import uk.gov.hmcts.reform.fis.document.model.DocAssemblyRequest;
import uk.gov.hmcts.reform.fis.document.model.DocAssemblyResponse;
import uk.gov.hmcts.reform.authorisation.generators.AuthTokenGenerator;

import java.util.Map;

import static uk.gov.hmcts.reform.fis.document.DocumentConstants.PDF;
import static uk.gov.hmcts.reform.fis.document.DocumentConstants.PDF_EXT;
